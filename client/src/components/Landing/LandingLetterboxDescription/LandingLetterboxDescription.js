import './LandingLetterboxDescription.scss';

const LandingLetterboxDescription = () => {
    return (
        <section className="landing-letterbox-description">
...
export default LandingLetterboxDescription;