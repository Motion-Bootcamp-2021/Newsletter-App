...
const Comment = ({commentEditHandler, commentId, authorId, content, publicationDate, author, likes, rating, avatar, user, userId, editionDate}) => {
    ...
    return (
        <div className='comment-container'>
            ...
            <div className='comment-content-wrapper'>
                ...
                <CommentActions likesCount={likesCount} likeHandler={likeHandler}/>
            </div>
        </div>
    )
}
