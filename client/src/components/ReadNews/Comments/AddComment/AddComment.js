...
const AddComment = ({ isCommentModalOpen, commentInputModalOpenHandler, newsId, user }) => {
    ...
    const sendComment = async (e) => {
        ...
        if(rating && content && user){
            ...
            try {
                await createComment(content, rating, idToken, newsId, user);
            ...
            <div className='add-comment-content'>
                <div className='add-comment-box'>
                    ...
                    <form>
                        ...
                        <textarea className='add-comment-area' rows='4' cols='43' name='content' onChange={(e)=>setContent(e.target.value)}/>
                    </form>
