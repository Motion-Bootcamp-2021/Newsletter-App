import { CREATE_FEED, GET_FEED, GET_ALL_FEEDS, ADD_NEWSLETTER, REMOVE_NEWSLETTER, CLEAR_FEED } from './actionTypes';

import { createFeed, getOneFeed, getAllFeeds, addNewsletterToFeed, removeNewsletterFromFeed } from '../services/feedService';
